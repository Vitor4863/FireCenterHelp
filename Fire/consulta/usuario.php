        ...
        <div class="modification">
            ...
            <form action="ModifyUserServlet" method="post">
                ...
                <div class="input-data">
                    ...
                    <input type="text" value="" name="personName" id="personName" autocomplete="off" required>
                    <div class="underline"></div>
                ...
                <div class="input-data">
                    ...
                    <input type="password" value="" name="userPassword" id="userPassword" autocomplete="off" required>
                    <div class="underline"></div>
                ...
                <div class="input-data">
                    ...
                    <input type="text" value="" name="cpf" id="cpf" autocomplete="off" required>
                    <div class="underline"></div>
